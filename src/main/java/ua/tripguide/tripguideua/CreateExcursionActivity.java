...
//        String cityName = Objects.requireNonNull(intent.getExtras()).getString("cityName");
        ...
        ArrayList<ObjectList> lstObjectList = dbHelper.getObjectsFromDB(cityId,false);
        ...
        llCreateExcurion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                price = new int[countCheckedObjects];
                ...
                for (int i = 0; i < countCheckedObjects; i++) {
                    ...
                    price[i] = numbersAdapter.getCheckedObjects().get(i).getPrice();
                }
